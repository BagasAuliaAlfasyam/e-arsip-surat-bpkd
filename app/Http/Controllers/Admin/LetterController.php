...
class LetterController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $query = Letter::with(['agency', 'sender'])->where('letter_type', 'Surat Masuk')->latest()->get();
    ...
    {
        if (request()->ajax()) {
            $query = Letter::with(['agency', 'sender'])->where('letter_type', 'Surat Keluar')->latest()->get();
    ...
    {
        $item = Letter::with(['agency', 'sender'])->findOrFail($id);
