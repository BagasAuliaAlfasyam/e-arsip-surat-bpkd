                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="letter_type" class="form-control" required>
                                            <option value="Surat Keluar" {{ old('letter_type') == 'Surat Keluar' ? 'selected' : '' }}>Surat Keluar
                                            </option>
                                        </select>
                                    </div>
                                    @error('letter_type')
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control @error('letterout_date') is-invalid @enderror"
                                            value="{{ old('letterout_date') }}" name="letterout_date" required>
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('regarding') is-invalid @enderror" value="{{ old('regarding') }}"
                                            name="regarding" placeholder="Perihal.." required>
                                    </div>
                                    @error('regarding')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                    ...
                                    <div class="col-sm-9">
                                        <select name="purpose" class="form-control @error('purpose') is-invalid @enderror" required>
                                            ...
                                            @foreach ($agencies as $agency)
                                                <option value="{{ $agency->name }}" {{ old('purpose') == $agency->name ? 'selected' : '' }}>
                                                    {{ $agency->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
