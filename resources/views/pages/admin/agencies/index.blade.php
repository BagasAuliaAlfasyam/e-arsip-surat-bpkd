            ...
            <div class="col-lg-12">
                <div class="card card-header-actions mb-4">
                    <div class="card-header">
                        List Instansi
                        <a class="btn btn-sm btn-primary" href="{{ route('agencies.create') }}" data-bs-toggle="modal" data-bs-target="#createModal">
                            Tambah Data
                        </a>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModal">Tambah Data Instansi</h5>
            ...
            <form action="{{ route('agencies.store') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="col-md-12">
                            <label for="post_id">Nama Instansi</label>
...
<div class="modal fade" id="updateModal{{ $id }}" role="dialog" aria-labelledby="createModal" aria-hidden="true" style="overflow:hidden;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('agencies.update', $item->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <div class="mb-3">
                        <div class="col-md-12">
                            <label for="post_id">Nama Instansi</label>
                            <input type="text" name="name" value="{{ $name; }}" class="form-control" placeholder="Masukan Nama Instansi.." required>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
